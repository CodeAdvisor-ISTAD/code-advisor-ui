    ...
    return (
        <div className="min-h-screen flex items-center justify-center">
            ...
            <div className="absolute inset-0">
                ...
                <XIcon className="absolute bottom-[30%] right-[20%] w-10 h-10 lg:w-8 lg:h-8 text-primary"
                       strokeWidth={8}/>
                <CircleIcon className="absolute top-[15%] right-[15%] w-12 h-12 lg:w-10 lg:h-10 text-primary"
                            strokeWidth={3}/>
                <CircleIcon className="absolute bottom-[20%] left-[25%] w-12 h-12 lg:w-10 lg:h-10 text-primary"
                            strokeWidth={3}/>
            </div>
