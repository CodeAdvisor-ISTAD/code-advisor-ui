...
export default function ReadingHistoryPage() {
  ...
  return (
    <div className=" h-screen mx-auto w-full lg:ml-[350px] lg:max-w-5xl md:max-w-5xl mb-5 mt-[76px] px-2">
      {/* <div className="md:col-span-3 lg:col-span-1"></div> */}
      <div className="w-full p-4 md:col-span-4 ">
        {loading ? (
          <div className="lg:col-span-4 md:col-span-4">
            <Skeleton className="lg:w-[275px] md:w-[300px] w-[200px]  lg:h-8 md:h-9 h-4 mt-2 "></Skeleton>
            <Skeleton className="lg:w-[200px] md:w-[200px] w-[175px]  lg:h-6 md:h-7 h-2 mt-2 "></Skeleton>
            <Skeleton className="w-full flex justify-center lg:h-72 md:h-56 h-48 mt-2"></Skeleton>
            <Skeleton className="lg:w-[200px] md:w-[200px] w-[175px]  lg:h-6 md:h-7 h-2 mt-2 "></Skeleton>
            <Skeleton className="w-full flex justify-center lg:h-72 md:h-56 h-48 mt-2"></Skeleton>
          </div>
        ) : (
