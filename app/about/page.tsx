            ...
            <div className="relative z-10">
                <main className="overflow-hidden relative z-10">
                    ...
                    <section className="mt-40">
                        ...
                        {/* Main Content */}
                        <div
                            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-2 gap-12 items-center">
                            {/* Text Section */}
                            <div className="space-y-8" data-aos="fade-right">
                                ...
                                <p className="text-base md:text-lg lg:text-lg 2xl:text-lg ml-4 md:ml-28 lg:ml-28 2xl:ml-28 text-gray-700">
                                    CodeAdvisors ផ្តល់បទពិសោធន៍ដល់ Developers
                    ...
                    {/* About Section */}
                    <section className="mx-auto bg-white  mt-20 border border-gray-100">
                    ...
                    <section className="text-white mt-20 border border-gray-100 bg-white">
                        <div className="">
                            ...
                            <div
                                className="grid grid-cols-1 lg:grid-cols-2 mx-4 md:mx-52 lg:mx-52 2xl:mx-52 items-center mb-10">
                                <div className="space-y-6">
                                    {[
                                        ...
                                        >
                                            <div
                                                className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 lg:w-12 lg:h-12 2xl:w-12 2xl:h-12 rounded-full bg-primary flex items-center justify-center ">
                                                {item.icon}
                                            </div>
                                            <div>
                    ...
                    <div className="w-full rounded-sm bg-white">
                        <section className="mx-4 md:mx-36 lg:mx-36 2xl:mx-36 mb-16">
                            <div
                                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-2 items-center">
                                <div
