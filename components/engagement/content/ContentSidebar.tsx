...
export function ContentSidebar({reactions, comment, bookmark, contentId }: Content) {
  const [isCommentFilled, setIsCommentFilled] = useState(false);
  const [isBookmarkFilled, setIsBookmarkFilled] = useState(false);
  const [currentBookmarkCount, setCurrentBookmarkCount] = useState(bookmark || 0);  // Initialize with a default value of 0 if bookmarksCount is undefined
  ...
  const totalReactions = localReactions.like + localReactions.love + localReactions.fire;
  ...
  return (
    <SidebarComment className="stick" collapsible="none" side="left">
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu className="py-8 gap-y-8">
              ...
              <SidebarMenuItem>
                <div className="mx-4 justify-self-end">
                  <ReactionButton reactions={localReactions} onReactionChange={handleReactionClick}/>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="px-2">
                    <DropdownMenuGroup>
                      ...
                      <DropdownMenuItem>
                        <a href={`/report/${contentId}/content`}>Report Abuse</a>
                      </DropdownMenuItem>
                    </DropdownMenuGroup>
                  </DropdownMenuContent>
                </DropdownMenu>
