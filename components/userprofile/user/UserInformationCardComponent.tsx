...
export default function UserInformationCardComponent(userInformation) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <Card className="w-full lg:p-6 p-3 rounded-lg bg-white">
        ...
        <Table>
          <TableBody>
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">នាម</TableCell>
              <TableCell className="text-right lg:text-lg text-sm pb-[10px] font-bold">
                {user?.fullName ? user?.fullName : "មិនមានទិន្នន័យ"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">ឈ្មោះគណនី</TableCell>
              <TableCell className="text-right lg:text-lg text-sm pb-[10px] font-bold">
                {user.username || "មិនមានទិន្នន័យ"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">អុីម៉ែល</TableCell>
              <TableCell className="text-right lg:text-lg text-sm pb-[10px] font-bold">
                {user.email || "មិនមានទិន្នន័យ"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">លេខទូរស័ព្ទ</TableCell>
              <TableCell className="text-right font-roboto lg:text-lg text-sm pb-[10px] font-bold">
                {user.phoneNumber || "មិនមានទិន្នន័យ"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">ភេទ</TableCell>
            ...
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">ទីកន្លែងកំណើត</TableCell>
              <TableCell className="text-right font-khFont lg:text-lg text-sm pb-[10px] font-bold">
                {user.pob || "មិនមានទិន្នន័យ"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="lg:text-lg text-sm pb-[10px]">តួនាទី</TableCell>
              <TableCell className="text-right font-roboto lg:text-lg text-sm pb-[10px] font-bold">
