...
export function PublicAchievementComponent() {
  ...
  return (
    <div className="flex items-center space-x-2">
      <Label htmlFor="publish-mode" className="font-semibold flex flex-row items-center gap-1" >
      {isPublic ? <EyeOff className="w-5 h-5 text-primary"/> : <Eye className="w-5 h-5 text-primary"/>}
