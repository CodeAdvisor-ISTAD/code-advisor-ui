...
export default function ColorPickerComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <Card className="w-full max-w-md mx-auto p-8 grid gap-8 shadow-md rounded-md bg-white dark:bg-gray-800">
        ...
        <div className="grid gap-4">
          ...
          <div
            className="w-full h-48 rounded-lg border-4 border-gray-200 dark:border-gray-700"
          ...
          <div className="grid gap-2 text-center">
            ...
            <Button
              ...
              variant="default"
              className="w-full bg-gray-500 text-white hover:bg-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600"
            >
              Copy to Clipboard
            </Button>
          </div>
